...
a,b=extract_data_sources(r"C:\Users\YBQB7360\Downloads\HDFS\HDFS\PROD\SCRIPTS\FT\IN_ZTE\insert_into_spark_ft_contract_snapshot.hql")
print("table principale",b)
print("les tables",len(a))