...
hdfs_dir = r"C:\Users\dokie\Downloads\hdfs-prod-bk-master\hdfs-prod-bk-master" #ex :C:\Users\dokie\Downloads\hdfs-prod-bk-master\hdfs-prod-bk-master
paths_scripts=r'C:\Users\dokie\Downloads\hdfs-prod-bk-master\hdfs-prod-bk-master\PROD\SCRIPTS'
file_scripts_paths=list_all_files(paths_scripts)
create_table_dic=process_hql_files(file_scripts_paths)
directory_conf = r"C:\Users\dokie\Downloads\hdfs-prod-bk-master\hdfs-prod-bk-master\PROD\CONF"
...
dict_fields_from_dwh=read_json(r"C:\Users\dokie\Documents\_data_gouv\tables_mon_fields_description_dict.json") 
